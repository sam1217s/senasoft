# Base de Conocimiento: Product Discovery para SENASoft 2025
...
**Principio clave:** Entregar patineta → bicicleta → carro, no esperar a tener el carro perfecto
...
**Preguntas clave para validar métricas:**
